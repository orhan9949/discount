...
class Kama_Breadcrumbs {
	...
	static $l10n = array(
		...
		'author'     => 'Archives of author: <b>%s</b>',
		'year'       => 'Archives for <b>%d</b> year',
		'month'      => 'Archives for: <b>%s</b>',
		'day'        => '',
		'attachment' => 'Media: %s',
		'tag'        => 'Post for tag: <b>%s</b>',
		'tax_tag'    => '%3$s',
	);
	...
	static $args = array(
		...
		'title_patt'      => '<li><span>%s</span></li>', // шаблон для последнего заголовка. Если включено: show_post_title или show_term_title
	...
	function get_crumbs( $sep, $l10n, $args ){
		...
		if(1){
			...
			if( ! $mark ) $mark = array(
				'wrappatt'  => '<div class="breadcrumbs"><ul>%s</ul></div>',
				'linkpatt'  => '<li><a href="%s">%s</a></li>',
				'sep_after' => '',
			);
			// rdf
			elseif( $mark === 'rdf.data-vocabulary.org' ) $mark = array(
				'wrappatt'   => '<div class="breadcrumbs" prefix="v: http://rdf.data-vocabulary.org/#"><ul>%s</ul></div>',
			...
			elseif( $mark === 'schema.org' ) $mark = array(
				'wrappatt'   => '<div class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList"><ul>%s</ul></div>',
