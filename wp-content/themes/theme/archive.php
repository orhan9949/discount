...
<main class="container">
    <div class="aside__block_item" style="display: none;">
        <div class="aside__items_s aside__items_shops">
            <div class="filter-blockDeals__header-and-body" id="cat">
                <div class="filter-blockDeals__header" tax-cat="categories" data-filter-cat="<?php echo $term->slug; ?>"></div>
            </div>
        </div>
    </div>
    <section>
        ...
        <?php
        $otherDeals = file_get_contents(get_template_directory() .'/array-page/categories/jsons/'.get_queried_object()->slug.'.json');
        $otherDeals_json = json_decode($otherDeals, true);
        ?>
        <h1><?php echo $otherDeals_json['term-name']; ?></h1>
        <div class="filter" data-cat="categories" data-filter-cat="<?php echo $term->slug; ?>">
            <form class="filter-form" action="">
                ...
                <div class="filter-sort" style="z-index: 10;">
                    <div class="filter-sort__name">by Store
                        <svg width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 9.58333L12 14.375L17 9.58333" stroke="#4F5460" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                    </div>
                    <div class="filter-sort__sort">
                        <div class="filter-sort__labels">
                            <div class="filter-sort__labels_items" id="cat_or_shop">
                                ...
                                $request = [];
                                $request['category'] = 'categories-shops';
        ...
        <div class="deals">
            <div class="deals__content">
                <div class="noflex_deals">
                    <div class="poroduct__list_all_deals products__list products__list_nopadding" id="item_list_name" item_list_name="Categories">
                                            ...
                                            <div views_click="<?php echo $row['views_click']; ?>">
                                                <div class="aside__item">
                                                    ...
                                                    <div class="aside__desc">
                                                        ...
                                                        <?php $term2 = get_the_terms( $row['ID'], 'categories-shops' ); ?>
                                                        <a href="<?php echo  $row['shop_link'] ; ?>" class="company__item">
                                                            <div class="category__icon">
                                                                <img src="<?php echo $row['shop_image_url']; ?>" alt="<?php echo esc_html( $term2[0]->term_id ); ?>">
                                                            </div>
                                                            <span> | <?php echo $term2[0]->name; ?></span>
                                                        </a>
