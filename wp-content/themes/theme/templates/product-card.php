...
<div class="product__card views-click" product-id="<?php echo get_the_ID(); ?>" views-click="<?php echo $total_views_click;?>">
    ...
    <div class="product__medium">
        ...
        <div class="hidden_mobile">
            <a href="<?php the_permalink(); ?>" target="_blank" class="product__card-a view_click">
                <?php if( $image ): ?>
    ...
    <div class="product__desc">
        ...
        <div class="hidden_mobile">
            ...
            <h2 class="product__title">
                <a href="<?php the_permalink(); ?>" target="_blank" class="view_click"><?php
                    if($amazon_asin){
        ...
        <div class="hidden_pc">
            ...
            <div class="product__title">
                <a href="<?php the_permalink(); ?>" class="view_click"><?php echo get_the_title() ?></a>
            </div>
            <div class="shop_icon">
                <?php
